...
const de: I18nSchema = {
    ...
    exam: {
        ...
        fileStudentSave: "Speichern",
        fileStudentUnknown: "Unbekannt",
        fileZoneEmpty: "Keine Dateien",
        fileStudentsEmpty: "Noch keine Schüler.",
        fileStudentBack: "← Schüler",
        fileUpdateError: "Datei konnte nicht aktualisiert werden",
        fileView: "Anzeigen",
        fileEdit: "Bearbeiten",
        fileCorrect: "Korrigieren",
        fileCorrecting: "Wird korrigiert...",
        fileCorrectError: "Korrektur der Abgabe fehlgeschlagen",
        addInstruction: "Hinweis hinzufügen",
        instructionCreateTitle: "Neuer Hinweis",
        instructionEditTitle: "Hinweis bearbeiten",
        instructionTitle: "Titel",
        instructionBody: "Inhalt",
        instructionSave: "Speichern",
        instructionSaving: "Wird gespeichert...",
        instructionTitlePrefix: "Hinweis ",
        instructionSaveError: "Hinweis konnte nicht gespeichert werden",
        instructionLoadError: "Hinweis konnte nicht geladen werden",
