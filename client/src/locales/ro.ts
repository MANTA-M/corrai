...
const ro: I18nSchema = {
    ...
    exam: {
        ...
        viewByType: "După tip",
        viewByAuthor: "După autor",
        fileTypeSubject: "Subiect",
        fileTypeSolution: "Rezolvare",
        fileTypeSubmission: "Lucrare",
        fileTypeInstructions: "Instrucțiuni",
        fileTypeUnknown: "Necunoscut",
        fileChangeType: "Schimbă tipul",
        fileSetAuthor: "Setează autorul",
        fileAuthorPlaceholder: "Numele autorului",
        fileAuthorSave: "Salvează",
        fileAuthorUnknown: "Necunoscut",
