...
const ro: I18nSchema = {
    ...
    exam: {
        ...
        fileStudentSave: "Salvează",
        fileStudentUnknown: "Necunoscut",
        fileZoneEmpty: "Niciun fișier",
        fileStudentsEmpty: "Niciun elev deocamdată.",
        fileStudentBack: "← Elevi",
        fileUpdateError: "Actualizarea fișierului a eșuat",
        fileView: "Vezi",
        fileEdit: "Editează",
        fileCorrect: "Corectează",
        fileCorrecting: "Se corectează...",
        fileCorrectError: "Corectarea lucrării a eșuat",
        addInstruction: "Adaugă instrucțiune",
        instructionCreateTitle: "Instrucțiune nouă",
        instructionEditTitle: "Editează instrucțiunea",
        instructionTitle: "Titlu",
        instructionBody: "Conținut",
        instructionSave: "Salvează",
        instructionSaving: "Se salvează...",
        instructionTitlePrefix: "Instrucțiune ",
        instructionSaveError: "Salvarea instrucțiunii a eșuat",
        instructionLoadError: "Încărcarea instrucțiunii a eșuat",
