...
const es: I18nSchema = {
    ...
    exam: {
        ...
        subject: "Asignatura",
        subjectPlaceholder: "Seleccione la asignatura",
        date: "Fecha",
        create: "Crear examen",
        creating: "Creando...",
        save: "Guardar",
        ...
        fileStudentUnknown: "Desconocido",
        fileZoneEmpty: "Sin archivos",
        fileStudentsEmpty: "Aún no hay alumnos.",
        fileStudentBack: "← Alumnos",
        fileUpdateError: "Error al actualizar el archivo",
        fileView: "Ver",
        fileEdit: "Editar",
        fileCorrect: "Corregir",
        fileCorrecting: "Corrigiendo...",
        fileCorrectError: "Error al corregir la entrega",
        addInstruction: "Añadir instrucción",
        instructionCreateTitle: "Nueva instrucción",
        instructionEditTitle: "Editar instrucción",
        instructionTitle: "Título",
        instructionBody: "Contenido",
        instructionSave: "Guardar",
        instructionSaving: "Guardando...",
        instructionTitlePrefix: "Instrucción ",
        instructionSaveError: "Error al guardar la instrucción",
        instructionLoadError: "Error al cargar la instrucción",
